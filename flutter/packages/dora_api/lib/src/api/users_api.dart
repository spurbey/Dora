...
class UsersApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserMetadataResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserMetadataResponse>> getUserMetadataApiV1UsersMeMetadataGet({ 
    required String authorization,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/users/me/metadata';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'authorization': authorization,
    ...
    UserMetadataResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserMetadataResponse),
    ...
    return Response<UserMetadataResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [UserMetadataResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserMetadataResponse>> upsertUserMetadataApiV1UsersMeMetadataPut({ 
    required String authorization,
    required UserMetadataUpdate userMetadataUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UserMetadataUpdate);
      _bodyData = _serializers.serialize(userMetadataUpdate, specifiedType: _type);
