...
void main() {
  ...
  group(UsersApi, () {
    ...
    //
    //Future deleteCurrentUserAccountApiV1UsersMeDelete(String authorization) async
    test('test deleteCurrentUserAccountApiV1UsersMeDelete', () async {
      // TODO
    });
    ...
    // Get User Metadata
    //
    //Future<UserMetadataResponse> getUserMetadataApiV1UsersMeMetadataGet(String authorization) async
    test('test getUserMetadataApiV1UsersMeMetadataGet', () async {
      // TODO
    });
    ...
    //
    //Future<UserMetadataResponse> upsertUserMetadataApiV1UsersMeMetadataPut(String authorization, UserMetadataUpdate userMetadataUpdate) async
    test('test upsertUserMetadataApiV1UsersMeMetadataPut', () async {
      // TODO
    });
