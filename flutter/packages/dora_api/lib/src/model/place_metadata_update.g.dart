...
part of 'place_metadata_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PlaceMetadataUpdate extends PlaceMetadataUpdate {
  @override
  ...
  factory _$PlaceMetadataUpdate(
          [void Function(PlaceMetadataUpdateBuilder)? updates]) =>
      (PlaceMetadataUpdateBuilder()..update(updates))._build();

  _$PlaceMetadataUpdate._(
      {this.componentType,
      this.experienceTags,
      this.bestFor,
      ...
      : super._();
  @override
  PlaceMetadataUpdate rebuild(
          void Function(PlaceMetadataUpdateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PlaceMetadataUpdateBuilder toBuilder() =>
      PlaceMetadataUpdateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PlaceMetadataUpdate &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PlaceMetadataUpdate')
...
class PlaceMetadataUpdateBuilder
    implements Builder<PlaceMetadataUpdate, PlaceMetadataUpdateBuilder> {
  _$PlaceMetadataUpdate? _$v;
  ...
  PlaceMetadataUpdateBuilder() {
    PlaceMetadataUpdate._defaults(this);
  }

  PlaceMetadataUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PlaceMetadataUpdate other) {
    _$v = other as _$PlaceMetadataUpdate;
  }

  @override
  void update(void Function(PlaceMetadataUpdateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PlaceMetadataUpdate build() => _build();

  _$PlaceMetadataUpdate _build() {
    _$PlaceMetadataUpdate _$result;
    try {
      _$result = _$v ??
          _$PlaceMetadataUpdate._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'PlaceMetadataUpdate', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
