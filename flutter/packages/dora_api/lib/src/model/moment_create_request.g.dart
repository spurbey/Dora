...
part of 'moment_create_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$MomentCreateRequest extends MomentCreateRequest {
  @override
  ...
  factory _$MomentCreateRequest(
      ...
      (MomentCreateRequestBuilder()..update(updates))._build();

  _$MomentCreateRequest._(
      ...
      : super._();
  @override
  MomentCreateRequest rebuild(
          void Function(MomentCreateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MomentCreateRequestBuilder toBuilder() =>
      MomentCreateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MomentCreateRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MomentCreateRequest')
...
class MomentCreateRequestBuilder
    implements Builder<MomentCreateRequest, MomentCreateRequestBuilder> {
  _$MomentCreateRequest? _$v;
  ...
  MomentCreateRequestBuilder() {
    MomentCreateRequest._defaults(this);
  }

  MomentCreateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(MomentCreateRequest other) {
    _$v = other as _$MomentCreateRequest;
  }

  @override
  void update(void Function(MomentCreateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MomentCreateRequest build() => _build();

  _$MomentCreateRequest _build() {
    _$MomentCreateRequest _$result;
    try {
      _$result = _$v ??
          _$MomentCreateRequest._(
            clientEventId: BuiltValueNullFieldError.checkNotNull(
                clientEventId, r'MomentCreateRequest', 'clientEventId'),
            capturedAt: BuiltValueNullFieldError.checkNotNull(
                capturedAt, r'MomentCreateRequest', 'capturedAt'),
            note: note,
