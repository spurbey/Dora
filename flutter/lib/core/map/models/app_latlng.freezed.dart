...
mixin _$AppLatLng {
  ...
  /// Serializes this AppLatLng to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AppLatLng
...
/// @nodoc
@JsonSerializable()
class _$AppLatLngImpl implements _AppLatLng {
...
abstract class _AppLatLng implements AppLatLng {
